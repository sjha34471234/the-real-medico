...
// PURPOSE: Public Printify products endpoint with fallback
// LAST CHANGED: May 13, 2026
// WHY IT EXISTS: Store pages fetch products via this route
// ⚠️ DO NOT CHANGE: Fallback products ensure store never shows empty
//   even if Printify API is down. Never remove the fallback.
// ============================================================
...
export async function GET() {
  ...
  // [May 13, 2026] REASON: Always return fallback if Printify fails —
  // store must never show empty. Never throw errors from this route.
